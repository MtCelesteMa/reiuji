...
DEFAULT_COMPONENTS: list[core.components.Component] = [
    ...
    AcceleratorCooler(name="lapis", cooling=130, placement_rule="one yoke && one magnet", short_name="Lp"),
    ...
    AcceleratorCooler(name="end_stone", cooling=50, placement_rule="one yoke", short_name="Es"),
    AcceleratorCooler(name="purpur", cooling=100, placement_rule="two end_stone coolers", short_name="Pp"),
    ...
    AcceleratorCooler(name="tin", cooling=120, placement_rule="two lapis coolers", short_name="Sn"),
    AcceleratorCooler(name="lead", cooling=65, placement_rule="one iron cooler", short_name="Pb"),
    AcceleratorCooler(name="boron", cooling=105, placement_rule="one yoke && one cavity", short_name="B "),
    AcceleratorCooler(name="lithium", cooling=125, placement_rule="one boron cooler", short_name="Li"),
    AcceleratorCooler(name="magnesium", cooling=150, placement_rule="one end_stone cooler && one prismarine cooler", short_name="Mg"),
    AcceleratorCooler(name="manganese", cooling=180, placement_rule="one gold cooler && one quartz cooler", short_name="Mn"),
    AcceleratorCooler(name="aluminium", cooling=175, placement_rule="one tin cooler && one quartz cooler", short_name="Al"),
    ...
    AcceleratorCooler(name="villaumite", cooling=170, placement_rule="one purpur cooler && one prismarine cooler", short_name="Vi"),
    AcceleratorCooler(name="carobbiite", cooling=140, placement_rule="one end_stone cooler && one gold cooler", short_name="Cb"),
    AcceleratorCooler(name="arsenic", cooling=145, placement_rule="two different cavity", short_name="As"),
    AcceleratorCooler(name="nitrogen", cooling=195, placement_rule="one lapis cooler && one gold cooler", short_name="N "),
    AcceleratorCooler(name="helium", cooling=200, placement_rule="one boron cooler && one lapis cooler", short_name="He"),
    AcceleratorCooler(name="enderium", cooling=190, placement_rule="three purpur coolers", short_name="Ed"),
    AcceleratorCooler(name="cryotheum", cooling=205, placement_rule="three tin coolers", short_name="Cr"),
]
