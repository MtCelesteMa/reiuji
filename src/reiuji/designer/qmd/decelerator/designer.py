...
class DeceleratorDesigner(base.designer.Designer):
    def __init__(
            self,
            side_length: int,
            minimum_energy: int,
        ...
        super().__init__(components=components if not isinstance(components, type(None)) else synchrotron.models.DEFAULT_COMPONENTS)
